...
SharedData.MaxAmmo    = {
    AMMO_PISTOL = 40,
    AMMO_PISTOL_EXPRESS = 40,
    AMMO_PISTOL_EXPRESS_EXPLOSIVE = 40,
    AMMO_PISTOL_HIGH_VELOCITY = 40,
    AMMO_PISTOL_SPLIT_POINT = 40,
    AMMO_REPEATER = 40,
    AMMO_REPEATER_EXPRESS = 40,
    AMMO_REPEATER_EXPRESS_EXPLOSIVE = 40,
    AMMO_REPEATER_HIGH_VELOCITY = 40,
    AMMO_REPEATER_SPLIT_POINT = 40,
    AMMO_REVOLVER = 40,
    AMMO_REVOLVER_EXPRESS = 40,
    AMMO_REVOLVER_EXPRESS_EXPLOSIVE = 40,
    AMMO_REVOLVER_HIGH_VELOCITY = 40,
    AMMO_REVOLVER_SPLIT_POINT = 40,
    AMMO_RIFLE = 60,
    AMMO_RIFLE_ELEPHANT = 60,
    AMMO_RIFLE_EXPRESS = 60,
    AMMO_RIFLE_EXPRESS_EXPLOSIVE = 60,
    AMMO_RIFLE_HIGH_VELOCITY = 60,
    AMMO_RIFLE_SPLIT_POINT = 60,
    AMMO_22 = 100,
    AMMO_22_TRANQUILIZER = 60,
    AMMO_SHOTGUN = 30,
    AMMO_SHOTGUN_BUCKSHOT_INCENDIARY = 30,
    AMMO_SHOTGUN_SLUG_EXPLOSIVE = 30,
